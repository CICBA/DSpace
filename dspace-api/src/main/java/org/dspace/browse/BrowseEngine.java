...
//            BrowseInfo browseInfo = new BrowseInfo(results, position, total, offset);
    ...
    private BrowseInfo browseByValue(BrowserScope bs)
        ...
        try {
            ...
            dao.setStartsWith("0".equals(scope.getStartsWith()) && !scope.getOrder().equals("ASC") ? "9" : OrderFormat.makeSortString(scope.getStartsWith(), null,(browseIndex.getDataType())));
